...
func (s *Stmt) QueryContext(ctx context.Context, args ...interface{}) (*Rows, error) {
	...
	return &Rows{ctx: ctx, rows: rows, killerPool: s.killerPool, connectionID: s.connectionID, serverID: s.serverID, flavor: s.flavor, killTimeout: s.killTimeout}, err
}
...
func (s *Stmt) QueryRowContext(ctx context.Context, args ...interface{}) *Row {
	...
	return &Row{ctx: ctx, row: row, killerPool: s.killerPool, connectionID: s.connectionID, serverID: s.serverID, flavor: s.flavor, killTimeout: s.killTimeout}
}
