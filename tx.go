...
func (tx *Tx) QueryContext(ctx context.Context, query string, args ...interface{}) (*Rows, error) {
	...
	return &Rows{ctx: ctx, rows: rows, killerPool: tx.killerPool, connectionID: tx.connectionID, serverID: tx.serverID, flavor: tx.flavor, killTimeout: tx.killTimeout}, err
}
...
func (tx *Tx) QueryRowContext(ctx context.Context, query string, args ...interface{}) *Row {
	...
	return &Row{ctx: ctx, row: row, killerPool: tx.killerPool, connectionID: tx.connectionID, serverID: tx.serverID, flavor: tx.flavor, killTimeout: tx.killTimeout}
}
